...
describe('The internet DEMO PAGE responsive', () => {
    ...
    it(`Validate elements in page in device ${size}`, {tags: '@regression'}, () => {
        cy.viewport(size)
    ...
    it(`Handling test in new tab into same tab in device ${size}`, () =>{
        cy.viewport(size)
     ...
     it(`Verify Add/Remove buttons in device ${size}`, {tags: '@regression'}, ()=>{
        cy.viewport(size)
     ...
     it(`Verify Checkboxes behaviour in device ${size}`, ()=>{
        cy.viewport(size)
     ...
     it(`Verify Forgot password page in device ${size}`, ()=>{
        cy.viewport(size)
     ...
     it(`Verify success login in device ${size}`, {tags: '@regression'}, ()=>{
        cy.viewport(size)
     ...
     it(`Verify login with invalid credentials in device ${size}`, {tags: '@regression'}, ()=>{
        cy.viewport(size)
        cy.get(':nth-child(21) > a').click()
